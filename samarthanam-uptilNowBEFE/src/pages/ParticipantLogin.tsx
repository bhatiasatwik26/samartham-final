  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (username === 'admin' && password === 'admin') {
      ...
      setTimeout(() => {
        ...
        localStorage.setItem('participant_auth', JSON.stringify({
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="text-center text-gray-500 dark:text-gray-400 text-sm">
                  <p>Don't have an account? <Link to="/participant-registration" className="text-red-600 dark:text-red-400 hover:underline">Sign up</Link></p>
